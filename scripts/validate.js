...
// хоть наставник и говорил, что валидацию лучше производить в момент открытия попапа, это критическая ошибка и надо отдельно писать функцию управления состоянием кнопки
// Активация валидации должна выполняться единоразово для всех форм сразу в global scope файла. Активировать ее каждый раз при открытии попапа некорректно -- поэтому здесь я вызываю функцию валидации всех форм и передаю ей объект настроек, а в index.js буду писать функцию muteButtonSubmit, которую добавлю в колбэки кнопок открытия модальных окон с формами.
